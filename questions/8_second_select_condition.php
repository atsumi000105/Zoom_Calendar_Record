...
$first_select_condition = str_replace($target, '', $str);
...
$sql = 'UPDATE contact_forms SET first_select_condition = ? WHERE line_id = ?';
$stmt = $dbh->prepare($sql);
$insert = $stmt->execute(array($first_select_condition, $line_user['id']));
$content = [
	[
		'type' => 'text', 'text' => '必要な条件を1つ教えて下さい（第二希望)', 'size' => 'sm'
	],
	[
		'type' => 'button', 'action' => [
